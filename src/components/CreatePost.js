const CreatePost = ({popupIsShown, setPopupIsShown, memberData}) => {   

  return (
    <>     
        <div className="card shadow-sm" style={{backgroundColor: "white", margin: "10px", borderRadius: "10px"}}>
            <div className="row p-3">
                <div className="col-2 col-md-1 p-1 d-flex justify-content-center">
                ...
                <div className="col d-flex align-items-center p-0">
                    <div className="bg-light w-100 p-2 d-flex align-items-center" style={{height:"40px", borderRadius: "20px"}}
